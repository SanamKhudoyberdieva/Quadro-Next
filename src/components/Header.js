        ...
        <nav className="navbar navbar-expand-lg">
            <div className="container">
                <a className="navbar-logo es-logo" href="#">
                    <Image src={require("../assets/img/logo_header.png")} className="img-fluid es-logo-img" alt="logo" />
                </a>
                <div className="collapse navbar-collapse es-header-nav">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#">Оферта</a>
                        </li>
                        <li className="nav-item">
                    ...
                    <div className="contact-nav">
                        <a href="tel:9987811301338">+99878 130 13 38</a>
                        <p className="working-hours">Каждый день с 11:00 до 00:00</p>
                    </div>
                    <ul className="navbar-nav">
                        <li className="nav-item active">
                            <a className="btn nav-link" href="#" data-toggle="modal" data-target="#registrationModal">
                                <svg width="51" height="51" viewBox="0 0 51 51" fill="none"
                                    ...
                                    <g clipPath="url(#clip0_201_3248)">
                                        ...
                                        <path
                                            ...
                                            stroke="#3B1E1C" strokeLinecap="round" strokeLinejoin="round" />
                                        <path
                            ...
                            <a className="nav-link" href="#">
                                <svg width="52" height="51" viewBox="0 0 52 51" fill="none"
                                    ...
                                    <g clipPath="url(#clip0_201_3257)">
                                        <rect x="26.3677" y="0.707107" width="35" height="35"
                                            transform="rotate(45 26.3677 0.707107)" stroke="#3B1E1C" />
                                        <rect x="26.3677" y="50" width="36" height="36"
                                            transform="rotate(45 26.3677 50)" fill="#3B1E1C" />
                                        <path
                            ...
                            <a className="nav-link" href="#">
                                <svg width="52" height="51" viewBox="0 0 52 51" fill="none"
                                    ...
                                    <g clipPath="url(#clip0_201_3265)">
                                        <rect x="26.2793" y="0.707107" width="35" height="35"
                                            transform="rotate(45 26.2793 0.707107)" stroke="#3B1E1C" />
                                        <rect x="26.2793" y="50" width="36" height="36"
                                            transform="rotate(45 26.2793 50)" fill="#3B1E1C" />
                                        <path
                                            ...
                                            stroke="#3B1E1C" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M33.3232 32.5L31.8232 31" stroke="#3B1E1C" strokeLinecap="round"
                            ...
                            <a className="nav-link" href="#">
                                <svg width="52" height="51" viewBox="0 0 52 51" fill="none"
                                    ...
                                    <g clipPath="url(#clip0_201_3274)">
                                        <rect x="26.1909" y="0.707107" width="35" height="35"
                                            transform="rotate(45 26.1909 0.707107)" stroke="#3B1E1C" />
                                        <rect x="26.1909" y="50" width="36" height="36"
                                            transform="rotate(45 26.1909 50)" fill="#3B1E1C" />
                                        <path
                                            ...
                                            stroke="#3B1E1C" strokeMiterlimit="10" strokeLinecap="round"
                                            strokeLinejoin="round" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#3B1E1C" strokeMiterlimit="10" strokeLinecap="round"
                                            strokeLinejoin="round" />
                                        <path d="M23.4849 22H32.4849" stroke="#3B1E1C" strokeMiterlimit="10"
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#">
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0.707107 19L19 0.707107L37.2929 19L19 37.2929L0.707107 19Z"
                                        stroke="#3B1E1C" />
                                    <path
                            ...
                            <a className="nav-link" href="#">
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#3B1E1C" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M25.6666 25.6667L24.3333 24.3333" stroke="#3B1E1C" strokeLinecap="round"
                                        strokeLinejoin="round" />
                                </svg>
                            </a>
                        </li>
                        <li className="nav-item">
                            <button className="btn nav-link" href="#" data-target="#menuModal" data-toggle="modal">
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19 0L38 19L19 38L0 19L19 0Z" fill="#3B1E1C" />
                                    <path d="M13 15.6667H25" stroke="#FEF3E1" strokeLinecap="round" />
                                    <path d="M13 19H25" stroke="#FEF3E1" strokeLinecap="round" />
                                    <path d="M13 22.3333H25" stroke="#FEF3E1" strokeLinecap="round" />
                                </svg>
                            </button>
                        </li>
                    </ul>
